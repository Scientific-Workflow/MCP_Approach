...
This is an agentic system that reproduces computational scientific workflows described
in research papers, **end to end and autonomously**. You point it at a PDF and a goal
("Reproduce this workflow using LAMMPS and OVITO"), and a pipeline of LLM agents reads
